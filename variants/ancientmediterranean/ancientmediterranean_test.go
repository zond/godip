...
func TestByzantium(t *testing.T) {
	...
	judge.SetUnit("aeg", godip.Unit{cla.Fleet, Greece})
	...
	judge.SetUnit("byz", godip.Unit{cla.Fleet, Greece})
...
func TestHighSeas(t *testing.T) {
	...
	judge.SetUnit("aus", godip.Unit{cla.Fleet, Greece})
	...
	judge.SetUnit("mes", godip.Unit{cla.Fleet, Greece})
	...
	judge.SetUnit("lib", godip.Unit{cla.Fleet, Greece})
...
func TestDiolkos(t *testing.T) {
	...
	judge.SetUnit("ion", godip.Unit{cla.Fleet, Greece})
...
func TestSicily(t *testing.T) {
	...
	judge.SetUnit("sic", godip.Unit{cla.Army, Rome})
	...
	judge.SetUnit("tys", godip.Unit{cla.Fleet, Rome})
...
func TestCorsica(t *testing.T) {
	...
	judge.SetUnit("cor", godip.Unit{cla.Army, Rome})
	judge.SetUnit("sad", godip.Unit{cla.Fleet, Rome})
...
func TestNileDelta(t *testing.T) {
	...
	judge.SetUnit("mem", godip.Unit{cla.Fleet, Rome})
...
func TestConvoyBaleares(t *testing.T) {
	...
	judge.SetUnit("sag", godip.Unit{cla.Army, Rome})
	judge.SetUnit("bal", godip.Unit{cla.Fleet, Rome})
	judge.SetUnit("lig", godip.Unit{cla.Fleet, Rome})
	...
	judge.SetUnit("bal", godip.Unit{cla.Army, Rome})
...
func TestAutomaticDisbands(t *testing.T) {
	...
	judge.SetUnit("cir", godip.Unit{cla.Army, Rome})
	judge.SetUnit("tha", godip.Unit{cla.Army, Rome})
	...
	judge.SetUnit("tar", godip.Unit{cla.Army, Carthage})
	judge.SetUnit("bal", godip.Unit{cla.Fleet, Carthage})
	judge.SetUnit("ber", godip.Unit{cla.Fleet, Carthage})
	judge.SetUnit("pun", godip.Unit{cla.Fleet, Carthage})
	judge.SetUnit("car", godip.Unit{cla.Fleet, Carthage})
	...
	tst.AssertUnit(t, judge, "pun", godip.Unit{cla.Fleet, Carthage})
	tst.AssertUnit(t, judge, "car", godip.Unit{cla.Fleet, Carthage})
}
