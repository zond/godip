...
var GatewayToTheWestVariant = common.Variant{
	...
	CreatedBy:   "TJ Brooks",
	Version:     "1",
	Description: `Alternative history variant. Missouri has just become a state 
	and exploration in the west is begining to pick up steam as settlers long for 
	a life in new lands. However, there are still native tribes living here. They hope
	to organize and reclaim the lands they once roamed.`,
