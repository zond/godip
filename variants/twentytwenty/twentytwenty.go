...
func TwentyTwentyStart() (result *state.State, err error) {
	...
	if err = result.SetUnits(map[godip.Province]godip.Unit{
		...
		"roe/ec": godip.Unit{godip.Fleet, Italy},
...
var provinceLongNames = map[godip.Province]string{
	...
	"mom": "Mombasa",
	"ira": "Iraq",
	"moc": "Mozambique Channel",
	"bar": "Barcelona",
	"now": "Norway",
	"mog": "Mongolia",
	"okl": "Oklahoma City",
	"sma": "South Mid Atlantic",
	"tri": "Tripoli",
	"gub": "Guiana Basin",
	"bat": "Baltic Sea",
	"mun": "Munich",
	...
	"com": "Comodoro Rivadavia",
	"uru": "Urumqi",
	"gha": "Ghana",
	"ned": "New Delhi",
	"diy": "Diyarbakir",
	"whi/nc": "Whitehorse (NC)",
	"los/wc": "Los Angeles (WC)",
	"los/ec": "Los Angeles (EC)",
	"mex/wc": "Mexico (WC)",
	"mex/ec": "Mexico (EC)",
	"col/wc": "Colombia (WC)",
	"col/nc": "Colombia (NC)",
