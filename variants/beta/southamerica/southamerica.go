...
var SouthAmericaVariant = common.Variant{
	...
	CreatedBy:   "",
	Version:     "",
	Description: "THIS IS A BETA MAP. IT MIGHT BE UPDATED AND CHANGED DURING YOUR GAME, WITHOUT WARNING. IT IS ONLY ACCESSIBLE OR VISIBLE FROM THE DIPLICITY BETA VERSION. ",
	Rules:       "",
}
